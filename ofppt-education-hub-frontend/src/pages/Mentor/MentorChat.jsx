...
export default function MentorChat() {
  ...
  const sendMessage = async () => {
    ...
    // Optimistic update — message apparaît immédiatement à droite
    const optimistic = {
      id: `tmp-${Date.now()}`,
    ...
    try {
      ...
      // Reload pour avoir le vrai message du serveur
      loadMessages(activeConv.id);
    } catch (err) {
      console.error(err);
    }
  ...
  const getOther = (conv) => {
    ...
    // user_one et user_two sont les objets complets avec .profil
    ...
    <div className="mc-root">
      ...
      <aside className="mc-sidebar">
        <div className="mc-sidebar__head">
          ...
          <button className="mc-icon-btn" title="Nouvelle conversation">
            <Edit size={18} />
          </button>
        </div>
        ...
        {!activeConv ? (
          ...
          <>
              ...
              <div className="mc-main__topbar-left">
                ...
                <div>
                  ...
                  <p className="mc-main__status">
                    <span className="mc-dot" /> Actif maintenant
                  </p>
                </div>
              </div>
            ...
            <div className="mc-messages">
              ...
              {Object.entries(grouped).map(([day, msgs]) => (
                <div key={day}>
                  ...
                  {msgs.map((msg) => {
                    // ← CLÉ : isMine compare sender_id avec l'id du mentor connecté
                    ...
                    return (
                      ...
                      >
                        {/* Avatar gauche — message de l'autre */}
                        {!isMine && (
                          <Avatar
            ...
            <div className="mc-input-bar">
              ...
              <textarea
                className="mc-input"
                placeholder={`Écrire à ${other?.profil?.nom_complet ?? "..."}...`}
                value={text}
      ...
      {activeConv && other && (
        <aside className="mc-info">
          ...
          <div className="mc-info__section">
            ...
            <div className="mc-info__row">
              <span className="mc-info__label">Rôle</span>
              <span className="mc-info__value">{other?.role ?? "—"}</span>
            </div>
            {other?.profil?.bio && (
              <div className="mc-info__row">
